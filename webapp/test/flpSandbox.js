		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoices list",
									"targetURL": "#logaliigroupsinvoicess-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaliigroupsinvoicess-display": {
								"semanticObject": "logaliigroupsinvoicess",
								"action": "display",
								"description": "invoicess list",
								"title": "invoices list",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaliigroups.invoicess",
									"url": sap.ui.require.toUrl("logaliigroups/invoicess")
								}
							}
						}
					}
